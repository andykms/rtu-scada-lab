...
@Component({
  selector: 'constructor-scene-http-client-block',
  templateUrl: './http-client-block.component.html',
  styleUrls: ['./http-client-block.component.css'],
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [SceneBlockComponent],
})
export class HttpClientBlockComponent {
