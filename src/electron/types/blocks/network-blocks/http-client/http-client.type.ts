...
import { IHttpClientRequestBodyDataTypes } from "./data-types/request/http-client.request-data-body.type";
...
import { EHttpClientResponseDataType } from "./data-types/response/http-client.response-data-type.type";
...
export interface IHttpClientBlock
  ...
  responseData: {
    type: EHttpClientResponseDataType;
    fromHeaders: IHttpClientReponseHeaders | null;
    fromBody: {
    ...
    fromCookies: IHttpClientReponseCookies | null;
  };
